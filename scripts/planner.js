...
function planner_controller($scope){
	...
	********************************/
	function init(){
        ...
        // List mods
        self.cinfo_settings.mods_available = ["Vanilla", "Ancient Crops", "Bonster's Fruits + Veggies", "Cannabis Kit", "Champagne Wishes", "Christmas Crops", "Fantasy Crops", "Farmer to Florist",
